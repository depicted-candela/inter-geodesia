    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archivo', models.FileField(help_text='Archivo del que provienen los datos', upload_to='media/estandarizados/gravimetria')),
                ('reporte', models.FileField(help_text='Reporte que explica los datos', upload_to='reportes/gravimetria')),
                ('pry_id', models.ForeignKey(help_text='Proyecto general relacionado', on_delete=django.db.models.deletion.CASCADE, to='estandarizar.proyectos')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='proyecto_terrestre_estandarizado', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pry_id', models.ForeignKey(help_text='Proyecto general relacionado', on_delete=django.db.models.deletion.CASCADE, to='estandarizar.proyectos')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='proyecto_oceanico', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pry_id', models.ForeignKey(help_text='Proyecto general relacionado', on_delete=django.db.models.deletion.CASCADE, to='estandarizar.proyectos')),
                ('usuario', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='proyecto_aereo', to=settings.AUTH_USER_MODEL)),
            ],
            options={
